...
Macro definitions
***********************************************************************************************************************/
#define SF_AUDIO_PLAYBACK_HW_DAC_CODE_VERSION_MAJOR   (2U)
#define SF_AUDIO_PLAYBACK_HW_DAC_CODE_VERSION_MINOR   (0U)
...
typedef struct st_sf_audio_playback_hw_dac_instance_ctrl
{
    ...
    volatile bool               is_dac_ramped_up;      ///< Whether the DAC is ramped up to half of maximum output.
