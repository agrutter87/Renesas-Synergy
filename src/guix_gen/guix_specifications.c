...
GX_WINDOW_PROPERTIES init_window_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_TEXT_BUTTON_PROPERTIES init_window_windowchanger_properties =
{
...
GX_CHECKBOX_PROPERTIES init_window_buttonenabler_properties =
{
...
GX_PROMPT_PROPERTIES init_window_instructions_properties =
{
...
GX_PROMPT_PROPERTIES init_window_window1_text_properties =
{
...
GX_CONST GX_STUDIO_WIDGET init_window_window1_text_define =
{
    "window1_text",
    ...
    {360, 456, 439, 479},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(INIT_WINDOW_CONTROL_BLOCK, init_window_window1_text), /* control block */
    (void *) &init_window_window1_text_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET init_window_instructions_define =
{
    "instructions",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {15, 170, 784, 249},                     /* widget size                    */
    &init_window_window1_text_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(INIT_WINDOW_CONTROL_BLOCK, init_window_instructions), /* control block */
    (void *) &init_window_instructions_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET init_window_buttonenabler_define =
{
    "buttonenabler",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {620, 30, 779, 109},                     /* widget size                    */
    &init_window_instructions_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(INIT_WINDOW_CONTROL_BLOCK, init_window_buttonenabler), /* control block */
    (void *) &init_window_buttonenabler_properties /* extended properties      */
};

GX_CONST GX_STUDIO_WIDGET init_window_windowchanger_define =
{
    "windowchanger",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {45, 30, 224, 79},                       /* widget size                    */
    &init_window_buttonenabler_define,       /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(INIT_WINDOW_CONTROL_BLOCK, init_window_windowchanger), /* control block */
    (void *) &init_window_windowchanger_properties /* extended properties      */
};

GX_CONST GX_STUDIO_WIDGET init_window_define =
{
    "init_window",
    GX_TYPE_WINDOW,                          /* widget type                    */
    ID_INIT_WINDOW,                          /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* next widget                    */
    &init_window_windowchanger_define,       /* child widget                   */
    0,                                       /* control block                  */
