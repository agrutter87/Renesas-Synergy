...
/*  Date (dd.mm.yyyy): 15. 4.2023   Time (hh:mm): 07:24                        */
/*******************************************************************************/
...
GX_SPRITE_FRAME w_bg_usb_ico_usb_frame_list[24] =
{
    {
        GX_PIXELMAP_ID_ICO_USB,              /* pixelmap id                    */
        0,                                   /* x offset                       */
        0,                                   /* y offset                       */
        20,                                  /* frame delay                    */
        GX_SPRITE_BACKGROUND_NO_ACTION,      /* background operation           */
...
GX_SPRITE_PROPERTIES w_bg_usb_ico_usb_properties =
{
    w_bg_usb_ico_usb_frame_list,             /* address of frame list          */
    24,                                      /* frame count                    */
};
...
GX_CONST GX_STUDIO_WIDGET w_bg_usb_txt_usb_2_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {320, 240, 639, 279},                    /* widget size                    */
    &w_bg_usb_ico_usb_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET w_bg_usb_w_usb_define =
{
    ...
    {0, 0, 799, 479},                        /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    &w_bg_usb_txt_usb_1_define,              /* child widget definition        */
...
GX_PIXELMAP_BUTTON_PROPERTIES w_bg_main_btn_vol_up_properties =
{
    GX_PIXELMAP_ID_BTN_VOL_UP,               /* normal pixelmap id             */
    0,                                       /* selected pixelmap id           */
    0                                        /* disabled pixelmap id           */
};
GX_PIXELMAP_BUTTON_PROPERTIES w_bg_main_btn_vol_down_properties =
{
...
GX_CONST GX_STUDIO_WIDGET w_bg_main_btn_vol_down_define =
{
    "btn_vol_down",
    ...
    (void *) &w_bg_main_btn_vol_down_properties /* extended properties         */
};

GX_CONST GX_STUDIO_WIDGET w_bg_main_btn_vol_up_define =
{
    "btn_vol_up",
    GX_TYPE_PIXELMAP_BUTTON,                 /* widget type                    */
    ...
    (void *) &w_bg_main_btn_vol_up_properties /* extended properties           */
};
...
GX_CONST GX_STUDIO_WIDGET w_bg_main_w_main_define =
{
    ...
    {0, 0, 799, 479},                        /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    &w_bg_main_txt_status_define,            /* child widget definition        */
