...
#ifndef _AUDIO_PLAYER_SPECIFICATIONS_H_
#define _AUDIO_PLAYER_SPECIFICATIONS_H_
...
#define ID_WIN_SPLASH 1
#define ID_WIN_USB 2
#define ID_WIN_MAIN 3
#define ID_LIST_FILES 4
#define ID_BTN_RIGHT 5
#define ID_BTN_MID 6
#define ID_BTN_LEFT 7
#define ID_BTN_VOL_UP 8
#define ID_BTN_VOL_DOWN 9
...
typedef struct W_BG_SPLASH_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_WINDOW w_bg_splash_w_splash;
    GX_PROMPT w_bg_splash_txt_version;
    GX_SPRITE w_bg_splash_ico_logo;
} W_BG_SPLASH_CONTROL_BLOCK;

typedef struct W_BG_USB_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_WINDOW w_bg_usb_w_usb;
    GX_PROMPT w_bg_usb_txt_usb_1;
    GX_PROMPT w_bg_usb_txt_usb_2;
    GX_SPRITE w_bg_usb_ico_usb;
} W_BG_USB_CONTROL_BLOCK;

typedef struct W_BG_MAIN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_WINDOW w_bg_main_w_main;
    GX_PROMPT w_bg_main_txt_status;
    GX_PROMPT w_bg_main_txt_time;
    GX_PROGRESS_BAR w_bg_main_bar_volume;
    GX_VERTICAL_LIST w_bg_main_list_files;
    GX_PROMPT w_bg_main_list_item_0;
    GX_PROMPT w_bg_main_list_item_1;
    GX_PROMPT w_bg_main_list_item_2;
    GX_PROMPT w_bg_main_list_item_3;
    GX_PROMPT w_bg_main_list_item_4;
    GX_PIXELMAP_BUTTON w_bg_main_btn_right;
    GX_PIXELMAP_BUTTON w_bg_main_btn_mid;
    GX_PIXELMAP_BUTTON w_bg_main_btn_left;
    GX_PIXELMAP_BUTTON w_bg_main_btn_vol_up;
    GX_PIXELMAP_BUTTON w_bg_main_btn_vol_down;
} W_BG_MAIN_CONTROL_BLOCK;


/* extern statically defined control blocks                                    */

#ifndef GUIX_STUDIO_GENERATED_FILE
extern W_BG_SPLASH_CONTROL_BLOCK w_bg_splash;
extern W_BG_USB_CONTROL_BLOCK w_bg_usb;
extern W_BG_MAIN_CONTROL_BLOCK w_bg_main;
#endif
