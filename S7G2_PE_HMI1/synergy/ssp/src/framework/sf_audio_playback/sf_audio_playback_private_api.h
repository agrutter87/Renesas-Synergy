...
#ifndef SF_AUDIO_PLAYBACK_PRIVATE_API_H
#define SF_AUDIO_PLAYBACK_PRIVATE_API_H
 ...
 **********************************************************************************************************************/
ssp_err_t SF_AUDIO_PLAYBACK_Open(sf_audio_playback_ctrl_t * const p_ctrl, sf_audio_playback_cfg_t const * const p_cfg);
...
ssp_err_t SF_AUDIO_PLAYBACK_VolumeSet(sf_audio_playback_ctrl_t * const p_ctrl, uint8_t const volume);
ssp_err_t SF_AUDIO_PLAYBACK_VersionGet (ssp_version_t * const p_version);

/* Common macro for SSP header files. There is also a corresponding SSP_HEADER macro at the top of this file. */
SSP_FOOTER

#endif /* SF_AUDIO_PLAYBACK_PRIVATE_API_H */
