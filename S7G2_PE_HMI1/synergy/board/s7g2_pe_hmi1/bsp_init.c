...
Macro definitions
***********************************************************************************************************************/
#define BSP_PRV_BUS_ARB_ROUND_ROBIN            (0x01U)  ///< Round-robin arbitration setting
...
void bsp_init (void * p_args)
{
    ...
    /** Set the arbitration method for the HMI bus to round-robin. */
    R_BUS->BUSSCNTHMI_b.ARBMET = BSP_PRV_BUS_ARB_ROUND_ROBIN;
