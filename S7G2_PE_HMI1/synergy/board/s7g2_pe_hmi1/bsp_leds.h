 ...
 * @defgroup BSP_S7G2HMI_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the S7G2 PE HMI board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
***********************************************************************************************************************/
...
{
    BSP_LED_LED2    = 0,    ///< LED2 (Green used when only LED2 is specified)
    BSP_LED_LED2_G  = 0,    ///< LED2 Green
