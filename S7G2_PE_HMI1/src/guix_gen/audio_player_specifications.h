...
#define ID_WIN_MAIN 2
#define ID_LIST_FILES 3
#define ID_BTN_RIGHT 4
#define ID_BTN_MID 5
#define ID_BTN_LEFT 6
#define ID_BTN_VOL_UP 7
#define ID_BTN_VOL_DOWN 8
...
typedef struct W_SPLASH_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_SPRITE w_splash_ico_logo;
    GX_PROMPT w_splash_txt_version;
} W_SPLASH_CONTROL_BLOCK;

typedef struct W_MAIN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_WINDOW w_main_w_files;
    GX_PROMPT w_main_txt_status;
    GX_PROMPT w_main_txt_time;
    GX_PROGRESS_BAR w_main_bar_volume;
    GX_VERTICAL_LIST w_main_list_files;
    GX_PROMPT w_main_list_item_0;
    GX_PROMPT w_main_list_item_1;
    GX_PROMPT w_main_list_item_2;
    GX_PROMPT w_main_list_item_3;
    GX_PROMPT w_main_list_item_4;
    GX_PIXELMAP_BUTTON w_main_btn_right;
    GX_PIXELMAP_BUTTON w_main_btn_mid;
    GX_PIXELMAP_BUTTON w_main_btn_left;
    GX_PIXELMAP_BUTTON w_main_btn_vol_up;
    GX_PIXELMAP_BUTTON w_main_btn_vol_down;
    GX_WINDOW w_main_w_navbar;
...
extern W_SPLASH_CONTROL_BLOCK w_splash;
